...
class TherapistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create therapist" do
    assert_difference('Therapist.count') do
      post therapists_url, params: { therapist: { address: @therapist.address, name: @therapist.name, specialty: @therapist.specialty } }
    end
  ...
  test "should update therapist" do
    patch therapist_url(@therapist), params: { therapist: { address: @therapist.address, name: @therapist.name, specialty: @therapist.specialty } }
